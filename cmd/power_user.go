...
import (
	...
	"github.com/zj1244/syft/internal/ui"
...
const powerUserExample = `  {{.appName}} {{.command}} <image>
  ...
  All behavior is controlled via application configuration and environment variables (see https://github.com/zj1244/syft#configuration)
`
